(function (global, factory) {
	...
	(global = global || self, factory(global['vue-tel-input-vuetify'] = {}));
	...
	*/
	...
	var script = {
	  ...
	  props: {
	    ...
	    appendOuterIcon: {
	      type: String,
	      default: function _default() {
	        return getDefault('appendOuterIcon');
	      }
	    },
	    hideArrow: {
	      type: Boolean,
	  ...
	  computed: {
	    ...
	    sortedCountries: function sortedCountries() {
	      ...
	      var preferredCountries = this.getCountries(this.preferredCountries).map(function (country) {
	        return _objectSpread$1(_objectSpread$1({}, country), {}, {
	          preferred: true
	        });
	      });
	  ...
	  methods: {
	    initializeCountry: function initializeCountry() {
	      ...
	      return new Promise(function (resolve) {
	        ...
	        if (_this4.phone && _this4.phone[0] === '+') {
	          ...
	          if (activeCountry) {
	            _this4.choose(_this4.findCountry(activeCountry));
	    ...
	    choose: function choose(country) {
	      ...
	      if (this.phone && this.phone[0] === '+' && this.activeCountry.iso2 && this.phoneObject.number.significant) {
	        ...
	        this.phone = PhoneNumber(this.phoneObject.number.significant, this.activeCountry.iso2).getNumber('international');
	    ...
	    onClickAppendOuterIcon: function onClickAppendOuterIcon(event) {
	  ...
	  return _c("div", {
	    ...
	    scopedSlots: _vm._u([{
	      ...
	      fn: function fn(data) {
	        ...
	        }), _vm._v(" "), _c("span", [_vm._v(_vm._s(data.item.name) + " " + _vm._s("+" + data.item.dialCode))])];
	      }
	    }]),
	    model: {
	    ...
	    on: {
	      ...
	      "click:append-outer": _vm.onClickAppendOuterIcon
	    },
	    scopedSlots: _vm._u([{
	      key: "append",
	      fn: function fn() {
	...
	var __vue_inject_styles__ = function __vue_inject_styles__(inject) {
	  ...
	  inject("data-v-e7f5c220_0", {
	    ...
	    map: undefined,
	    media: undefined
	  }), inject("data-v-e7f5c220_1", {
	    source: ".vti__flag {\n  margin-right: 8px;\n}\n.vue-tel-input-vuetify {\n  display: flex;\n  align-items: center;\n}\n.vue-tel-input-vuetify .country-code {\n  width: 75px;\n}\n.vue-tel-input-vuetify .country-code .v-select__selections {\n  justify-content: center;\n}\n.vue-tel-input-vuetify .country-code .hide-arrow .v-input__append-inner {\n  display: none;\n}\n.vue-tel-input-vuetify li.last-preferred {\n  border-bottom: 1px solid #cacaca;\n}\n.vue-tel-input-vuetify .v-text-field .v-select__selections {\n  position: relative;\n}\n.vue-tel-input-vuetify .v-text-field .v-select__selections .vti__flag {\n  position: absolute;\n  margin-left: 18px;\n}\n.vue-tel-input-vuetify .v-text-field--outlined .v-select__selections .vti__flag {\n  margin-left: auto;\n  margin-right: 0px;\n}\n\n/*# sourceMappingURL=vue-tel-input-vuetify.vue.map */",
	    map: {
	      "version": 3,
	      "sources": ["/home/pmorales/GIT/vue-tel-input-vuetify/src/lib/vue-tel-input-vuetify.vue", "vue-tel-input-vuetify.vue"],
	      "names": [],
	      "mappings": "AAouBA;EACA,iBAAA;ACnuBA;ADsuBA;EACA,aAAA;EACA,mBAAA;ACnuBA;ADquBA;EACA,WAAA;ACnuBA;ADouBA;EACA,uBAAA;ACluBA;ADouBA;EACA,aAAA;ACluBA;ADsuBA;EACA,gCAAA;ACpuBA;ADwuBA;EACA,kBAAA;ACtuBA;ADuuBA;EACA,kBAAA;EACA,iBAAA;ACruBA;AD0uBA;EACA,iBAAA;EACA,iBAAA;ACxuBA;;AAEA,oDAAoD",
	...
	function install(Vue) {
	  ...
	  utils.options = _objectSpread$2(_objectSpread$2({}, defaultOptions), customOptions);
